...
for file_name in file_names:
    ...
    result = {
        '文件名称': file_name,
        'criterion': dt_search.best_params_[
            'criterion'
        ],
        'splitter': dt_search.best_params_[
            'splitter'
        ],
        'max_depth': dt_search.best_params_[
            'max_depth'
        ],
        'min_samples_split': dt_search.best_params_[
            'min_samples_split'
        ],
        'min_samples_leaf': dt_search.best_params_[
            'min_samples_leaf'
        ],
        'max_features': dt_search.best_params_[
            'max_features'
        ],
        'max_leaf_nodes': dt_search.best_params_[
            'max_leaf_nodes'
        ],
        'ccp_alpha': dt_search.best_params_[
            'ccp_alpha'
        ],
        '交叉验证RMSE': cv_rmse,
        '测试集RMSE': rmse,
