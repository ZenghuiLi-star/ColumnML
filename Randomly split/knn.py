...
for j in range(len(name_list)):
    ...
    for i in range(1, 1000):
        ...
        knn = KNeighborsRegressor(n_neighbors=super_para[j][0], p=super_para[j][1],weights='uniform', n_jobs=-1)
    ...
    results_df.to_csv(f'data_evaluate\\knn_{path_list[j]}_evaluate.csv', index=False)
